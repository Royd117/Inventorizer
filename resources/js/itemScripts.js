...
function printItems(req) {
    ...
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && (this.status == 200)) {
            ...
            document.getElementById('tableResultI').innerHTML = result;
        } else {
            document.getElementById('tableResultI').innerHTML = 'No matches were found.';
        }
    };
    xhttp.open("GET", "./Controllers/searchItem.php?name="+req, true);
    xhttp.send();
}
...
function fillCategorySelect(){
    ...
    xhttp.open("GET", "./Controllers/searchCategory.php?name=", true);
    xhttp.send();
}
...
function sendToUpdate(name,category,description,quantity,status) {
    if(document.getElementById('InputChangeItemName').value == ''){
        ...
        window.location = "./Controllers/updateItem.php?id="+auxid+"&name="+name+"&category="+category+"&description="+description+"&quantity="+quantity+"&status="+status;
    }
}

function sendToCreate(name,category,description,quantity,status) {
    if(document.getElementById('InputNewItemName').value == ''){
        ...
        window.location = "./Controllers/createItem.php?name="+name+"&category="+category+"&description="+description+"&quantity="+quantity+"&status="+status;
    }   
}

function sendToDelete() {
    window.location = "./Controllers/deleteItem.php?id="+auxid;
}
